...
$(".tablaProductos tbody").on("click", "button.btnEditarProducto", function () {
	...
	$.ajax({
		...
		success: function (respuesta) {
			...
			$("#editarInventariable").val(respuesta["inventariable"]);
...
$(".tablaProductosEliminados tbody").on("click", "button.btnRestaurarProducto", function () {
	...
	swal({
		...
		title: '¿Está seguro de Restaurar el producto?',
		text: "¡Si no lo está puede cancelar la accíón!",
		type: 'warning',
		showCancelButton: true,
		confirmButtonColor: '#3085d6',
		cancelButtonColor: '#d33',
		cancelButtonText: 'Cancelar',
		confirmButtonText: 'Si, restaurar producto!'
	}).then(function (result) {
		if (result.value) {

			window.location = "index.php?ruta=productos&idProductoRestaurar=" + idProducto + "&codigo=" + codigo;
		}
