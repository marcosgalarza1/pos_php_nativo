...
RESTAURAR USUARIO
=============================================*/
$(".tablasusuariosEliminados").on("click", ".btnRestauraUsuario", function(){
	...
	swal({
	  ...
	  confirmButtonColor: '#3085d6',
		cancelButtonColor: '#d33',
		cancelButtonText: 'Cancelar',
		confirmButtonText: 'Si, Restauar usuario!'
	}).then(function(result){
  
	  if(result.value){
  
		window.location = "index.php?ruta=usuarios&idUsuarioRestaurar="+idUsuario+"&usuario="+usuario;
